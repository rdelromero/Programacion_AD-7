...
public class TestEmpleadoImpl {
	...
	public static void main(String[] args) {
		...
		System.out.println("Insercción en sql de ese empleado (devuelve true si el insert es satisfactorio)");
		...
		//Métodos DML-delete------------------------------------------------------------------------
		System.out.println("Dar de baja a ese empleado (devuelve true si el delete es satisfactorio)");
